...
function createBufferSource (src, opt) {
  ...
  Object.defineProperties(emitter, {
    ...
    ondurationchange: {
      enumerable: true, configurable: true,
      get: function () {
        return emitter._ondurationchange
      },
      set: function (n) {
        if (emitter._ondurationchange) {
          emitter.removeListener('durationchange', emitter._ondurationchange)
        }

        emitter._ondurationchange = n
        emitter.on('durationchange', n)
      }
    },
    playing: {
      enumerable: true, configurable: true,
